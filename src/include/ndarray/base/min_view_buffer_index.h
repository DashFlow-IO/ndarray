...
#ifndef NDARRAY_BASE_MIN_VIEW_BUFFER_INDEX_H
#define NDARRAY_BASE_MIN_VIEW_BUFFER_INDEX_H
 ...
 */
int64_t ndarray_min_view_buffer_index(
...
#endif  // !NDARRAY_BASE_MIN_VIEW_BUFFER_INDEX_H
