...
/* 
 * Copyright (c) 2022, the ndarray project authors. Please see  the CONTRIBUTORS file for details. All rights reserved. Use  of this source code is governed by a MIT-style license that can be found in the LICENSE file.
 */
